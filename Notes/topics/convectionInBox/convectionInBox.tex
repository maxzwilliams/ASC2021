...
\section*{Streamfunction-vorticity formulation}
We consider the problem in 2D cartesian co-ordinates (x,y). We define the streamfunction $\psi$ such that for velocities $u$ and  $v$ in the $x$ and $y$ direction that:
\begin{equation}
