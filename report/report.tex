...
%% do this at the very very end.

%% the hardest part, the introduction.
...
%% why do we even want to talk about the inner core???
 %% why is ths important
%% Here I could go on about imaging the inner core, why is it hard, 
%% then I could talk about difficulties for doing convection experiments in the inner core, its hard to generate a self-gravitating fluid, its hard to generate internal heating. This leaves. Analytic models tend to only work in very idealized systems, or give partial information, this leaves us with Numerical techniques as an insite into inner core convection.
%% 
